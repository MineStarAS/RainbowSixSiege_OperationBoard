...
class Square extends Sketch {
  Square(this.state, this.startX, this.startY);
  ...
  @override
  late final double thickness = state.getSketchThickness(SketchMode.SQUARE);
  @override
  late final double opacity = state.getSketchOpacity(SketchMode.SQUARE);
  ...
  widget() => Container(
    ...
    child: ColoredBox(color: color.withOpacity(opacity)),
      );
}
